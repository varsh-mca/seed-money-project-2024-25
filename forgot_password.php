...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("SELECT * FROM staff_data WHERE mail_id = ? AND staffid = ?");
    ...
    if ($result->num_rows > 0) {
        ...
        try {
            ...
            $mail->setFrom('your_email@example.com', 'Staff Changing Password For CO-Curricular activity');
